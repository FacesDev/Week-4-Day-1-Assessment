...
/*************************************************************************************
------------ ANSWER -------------------
no, X is Global, Y is local.
console.log(y) is undefined. Y is a local variable and is inside the scope of the function.
console.log(x) is "I'm a local variable". X is a global variable and is declared in the global window.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
Console.log(x) is undefined. X is defined below console.log() in the scope of the function.
console.log(foo) will return "function hoisting".
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
console.log(add) should return 4 for the log inside the IFEE and undefined outside the IFEE. the IFEE has a scope limited to iteself so variables called, even constants, will be limited to the scope of the function.
**************************************************************************************/
